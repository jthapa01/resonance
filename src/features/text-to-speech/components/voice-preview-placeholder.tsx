...
export function VoicePreviewPlaceholder() {
  return (
    <div className="hidden flex-1 lg:flex h-full flex-col items-center justify-center gap-6 rounded-t">
      ...
      <Button variant="outline" size="sm" nativeButton={false} render={<Link href="mailto:business@hotmail.com" />}>
        <BookOpen />
        Don&apos;t know how?
      </Button>
    </div>
