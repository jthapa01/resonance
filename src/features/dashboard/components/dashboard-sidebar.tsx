...
function NavSection({ label, items, pathname, mounted }: NavSectionProps) {
   return (
      <SidebarGroup>
...
export function DashboardSidebar() {
   ...
   const othersMenuItems: MenuItem[] = [
      ...
      },
      {
         ...
         url: "mailto:business@hotmail.com",
         icon: Headphones,
      },
   ];
   ...
   return (
      <Sidebar collapsible="icon">
         ...
         <SidebarContent>
            <NavSection items={mainMenuItems} pathname={pathname} mounted={mounted} />
            <NavSection label="Others" items={othersMenuItems} pathname={pathname} mounted={mounted} />
         </SidebarContent>
         <div className="border-b border-dashed border-border" />
